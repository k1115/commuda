...
import 'community_button_model.dart';
export 'community_button_model.dart';

class CommunityButtonWidget extends StatefulWidget {
  const CommunityButtonWidget({
    super.key,
    this.communityId,
  ...
  @override
  State<CommunityButtonWidget> createState() => _CommunityButtonWidgetState();
}

class _CommunityButtonWidgetState extends State<CommunityButtonWidget> {
  late CommunityButtonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommunityButtonModel());
