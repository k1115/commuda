...
import 'home_community_button_model.dart';
export 'home_community_button_model.dart';

class HomeCommunityButtonWidget extends StatefulWidget {
  const HomeCommunityButtonWidget({
    super.key,
    this.communityId,
  ...
  @override
  State<HomeCommunityButtonWidget> createState() =>
      _HomeCommunityButtonWidgetState();
}

class _HomeCommunityButtonWidgetState extends State<HomeCommunityButtonWidget> {
  late HomeCommunityButtonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeCommunityButtonModel());
