...
import 'community_report_bottom_sheet_model.dart';
export 'community_report_bottom_sheet_model.dart';

class CommunityReportBottomSheetWidget extends StatefulWidget {
  const CommunityReportBottomSheetWidget({
    super.key,
  ...
  @override
  State<CommunityReportBottomSheetWidget> createState() =>
      _CommunityReportBottomSheetWidgetState();
}

class _CommunityReportBottomSheetWidgetState
    extends State<CommunityReportBottomSheetWidget> {
  late CommunityReportBottomSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommunityReportBottomSheetModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    Navigator.pop(context);
                                    await CommunityReportsTable().insert({
