...
class CommunityCreateWidget extends StatefulWidget {
  ...
  static String routeName = 'CommunityCreate';
  static String routePath = '/communityCreate';
...
class _CommunityCreateWidgetState extends State<CommunityCreateWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.inviteCode = random_data.randomString(
        4,
        4,
        true,
        true,
    ...
    _model.summeryTextController ??= TextEditingController();
    _model.summeryFocusNode ??= FocusNode();

    _model.ruleTextController ??= TextEditingController();
                    ...
                    children: [
                                                              ...
                                                              : () async {
                                                                  ...
                                                                  if (selectedMedia !=
                                                                      ...
                                                                      selectedMedia.every((m) => validateFileFormat(
                                                                          ...
                                                                          context))) {
                                                                    safeSetState(() =>
                                                                        _model.isDataUploading_updatedImage =
                                                                            true);
                                                                    ...
                                                                    if (selectedUploadedFiles
                                                                      ...
                                                                      safeSetState(
                                                                          () {
                                                                        _model.uploadedLocalFile_updatedImage =
                                                                  ...
                                                                  if ((_model
                                                                              .uploadedLocalFile_updatedImage
                                                                              .bytes
                                                                              ?.isNotEmpty ??
                                                                          false)) {
                                                  ...
                                                  : () async {
                                                      ...
                                                      if (selectedMedia !=
                                                        ...
                                                        try {
                                                          ...
                                                          _model.isDataUploading_createdImage =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                                .length ==
                                                            selectedMedia
                                                                .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFile_createdImage =
                                                                selectedUploadedFiles
                                                                    .first;
                                                          });
                                                        } else {
                                                      ...
                                                      if ((_model
                                                                  .uploadedLocalFile_createdImage
                                                                  .bytes
                                                                  ?.isNotEmpty ??
                                                              false)) {
                      ...
                      Column(
                        ...
                        children: [
                                          ...
                                          onTap: () async {
                                            if ((_model.categories.length <=
                                              ...
                                              for (int loop1Index = 0;
                                                  loop1Index <
                                                      _model.tempStrList.length;
                                                  loop1Index++) {
                                                final currentLoop1Item = _model
                                                    .tempStrList[loop1Index];
                          ...
                          Builder(
                            builder: (context) {
                              final categoryList = _model.categories.toList();
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  wrapWithModel(
                                    model: _model.necessaryLabelModel5,
                                    updateCallback: () => safeSetState(() {}),
                                    child: NecessaryLabelWidget(),
                                  ),
                                ].divide(SizedBox(width: 8.0)),
                          ...
                          Column(
                            ...
                            children: [
                              FlutterFlowRadioButton(
                                ...
                                onChanged: (val) async {
                                  safeSetState(() {});
                                  if (_model.radioButton1Value != null &&
                          ...
                          Column(
                            ...
                            children: [
                              FlutterFlowRadioButton(
                                ...
                                onChanged: (val) async {
                                  safeSetState(() {});
                                  if (_model.radioButton3Value != null &&
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FlutterFlowRadioButton(
                                      ...
                                      onChanged: (val) async {
                                        safeSetState(() {});
                                        if (_model.radioButton4Value != null &&
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FlutterFlowRadioButton(
                                      ...
                                      onChanged: (val) async {
                                        safeSetState(() {});
                                        if (_model.radioButton5Value != null &&
                                              ...
                                              child: Container(
                                                ...
                                                child: Text(
                                                  '${valueOrDefault<String>(
                                                    _model.inviteURL,
                                                    'commuda://commuda.com',
                                                  )}/invitePage?inviteCode=${_model.inviteCode}',
                                                  maxLines: 1,
                                            ...
                                            FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                await Clipboard.setData(
                                                    ClipboardData(
                                                        text:
                                                            'https://commuda-l8cyux.flutterflow.app/invitePage?inviteCode=${_model.inviteCode}'));
                                              },
                                            ),
                                          ],
                                        ),
                                    ...
                                    : () async {
                                        ...
                                        if ((_model.categories.length != 0) &&
                                          ...
                                          _model.communityOutput =
                                              await CommunitiesTable().insert({
                                            'creator_id': _model
                                                .currentUser?.firstOrNull?.id,
                                            'name':
                                                _model.nameTextController.text,
                                            'description': _model
                                                .summeryTextController.text,
                                            'rules':
                                          ...
                                          await CommunityMembersTable().insert({
                                            'community_id':
                                                _model.communityOutput?.id,
                                            'user_id': FFAppState().userInfo.id,
                                            'participate_status': 1,
                                          });
                                          for (int loop1Index = 0;
                                              loop1Index <
                                                  _model.categories.length;
                                              loop1Index++) {
                                            final currentLoop1Item =
                                                _model.categories[loop1Index];
                                            _model.createdCategory =
