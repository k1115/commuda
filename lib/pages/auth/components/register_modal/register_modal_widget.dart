                              ...
                              if (!_model.isConfirm) {
                                return Form(
                                  ...
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      if (_model.passwordError != 0)
                                        wrapWithModel(
                                          model: _model.warningTextModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: WarningTextWidget(
                                            warning: _model.passwordError == 1
                                                ? '確認用のパスワードが一致しません。'
                                                : '同じメールアドレスまたはニックネームがすでに存在します。',
                                          ),
                                        ),
                                      Column(
                                        mainAxisSize: MainAxisSize.max,
                                                  ...
                                                  : () async {
                                                      ...
                                                      _model.emailUser =
                                                          await UsersTable()
                                                              .queryRows(
                                                        queryFn: (q) => q.or(
                                                            "email.eq.${_model.emailTextController.text}, nick_name.eq.${_model.nameTextController.text}"),
                                                      );
                                                      if (_model.emailUser !=
                                                              null &&
                                                          (_model.emailUser)!
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              _model.isShowPassword
                                                  ? _model
                                                      .passwordTextController
                                                      .text
                                                  : valueOrDefault<String>(
                                                      functions.generatePasswordString(
                                      ...
                                      onPressed: _model.disableButton
                                          ...
                                          : () async {
                                              ...
                                              await ProfileTable().insert({
                                                'user_id':
                                                    _model.userOutput?.id,
                                              });
                                              await UserNotificationsTable()
                                                  .insert({
                                                'user_id':
                                                    _model.userOutput?.id,
                                              });
                                              _model.userInfo =
                                                  await SupabaseDBGroup
                                                      .getUserInfoByAuthIdCall
                                                      .call(
                                                pAuthUserId: currentUserUid,
                                              );
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await ProfileTable().insert({
                                          'user_id': _model.googleOutput?.id,
                                        });
                                        await UserNotificationsTable().insert({
                                          'user_id': _model.googleOutput?.id,
                                        });
                                        _model.googleInfo =
                                            await SupabaseDBGroup
