...
import 'login_modal_model.dart';
export 'login_modal_model.dart';
...
class _LoginModalWidgetState extends State<LoginModalWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginModalModel());
                                ...
                                if (_model.authError)
                                  wrapWithModel(
                                    ...
                                    child: WarningTextWidget(
                                      warning:
                                          'ログインできませんでした。メールアドレスまたはパスワードをご確認ください。',
                                    ),
                                  ),
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: ((_model.emailAddressTextController
                                        ...
                                        : () async {
                                            Function() _navigate = () {};
                                            _model.validateSuccess = true;
                                            if (_model.formKey.currentState ==
                                                    null ||
                                                !_model.formKey.currentState!
                                                    .validate()) {
                                              _model.validateSuccess = false;
                                            }
                                            _model.disableButton = true;
                                            safeSetState(() {});
                                            _model.loginSuccess =
                                                await actions.authLogin(
                                              _model.emailAddressTextController
                                                  .text,
                                              _model
