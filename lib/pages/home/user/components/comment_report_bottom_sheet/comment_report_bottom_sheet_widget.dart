...
import 'comment_report_bottom_sheet_model.dart';
export 'comment_report_bottom_sheet_model.dart';

class CommentReportBottomSheetWidget extends StatefulWidget {
  const CommentReportBottomSheetWidget({
    super.key,
  ...
  @override
  State<CommentReportBottomSheetWidget> createState() =>
      _CommentReportBottomSheetWidgetState();
}

class _CommentReportBottomSheetWidgetState
    extends State<CommentReportBottomSheetWidget> {
  late CommentReportBottomSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentReportBottomSheetModel());
                        ...
                        Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await CommentReportsTable().insert({
                                    'report_user_id': widget.reportUserId,
                                    'reported_comment_id':
                                        widget.reportedCommentId,
