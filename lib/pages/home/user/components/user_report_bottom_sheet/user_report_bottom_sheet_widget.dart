...
import 'user_report_bottom_sheet_model.dart';
export 'user_report_bottom_sheet_model.dart';

class UserReportBottomSheetWidget extends StatefulWidget {
  const UserReportBottomSheetWidget({
    super.key,
  ...
  @override
  State<UserReportBottomSheetWidget> createState() =>
      _UserReportBottomSheetWidgetState();
}

class _UserReportBottomSheetWidgetState
    extends State<UserReportBottomSheetWidget> {
  late UserReportBottomSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserReportBottomSheetModel());
