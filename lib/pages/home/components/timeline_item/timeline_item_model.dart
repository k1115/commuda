...
class TimelineItemModel extends FlutterFlowModel<TimelineItemWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in TimelineCommunity widget.
  ...
  // Stores action output result for [Backend Call - Query Rows] action in TimelineCommentHeader widget.
  List<UserWithProfileRow>? userCommentOutput;
