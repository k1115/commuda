...
class InquiryWidget extends StatefulWidget {
  ...
  static String routePath = '/inquiry';
...
class _InquiryWidgetState extends State<InquiryWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<InquiryCategoriesRow>>(
      future: InquiryCategoriesTable().queryRows(
        queryFn: (q) => q,
      ),
      builder: (context, snapshot) {
        ...
        List<InquiryCategoriesRow> inquiryInquiryCategoriesRowList =
            snapshot.data!;
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                'お問い合わせ前に、よくある質問を確認してみませんか？すぐに解決できるかもしれません。',
                                                style:
                                            ...
                                            FlutterFlowDropDown<String>(
                                              controller: _model
                                                  ...
                                                  FormFieldController<String>(
                                                      null),
                                              options:
                                                  inquiryInquiryCategoriesRowList
                                                      .map((e) => e.category)
                                                      .toList(),
                                              onChanged: (val) async {
                                                safeSetState(() =>
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  hintText:
                                                      '例)通知が届かないのですが、どの設定を確認すれば良いでしょうか？',
                                                  hintStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .bodyMedium
                                                      .override(
                                      ...
                                      FFButtonWidget(
                                        onPressed: _model.disableButton
                                            ...
                                            : () async {
                                                ...
                                                _model.isInputed = true;
                                                _model.mailAddress = _model
                                                    .emailAddressTextController
                                                    .text;
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        await InquiriesTable().insert({
                                          ...
                                          'mail_address': _model.mailAddress,
                                          'content': _model.content,
                                          'status': 0,
                                        });
                                        context.safePop();
